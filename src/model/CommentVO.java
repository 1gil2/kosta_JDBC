...
public class CommentVO {
	...
	public CommentVO(int comment_no, String comment_writer, int comment_post, String comment_text, int comment_like) {
		super();
	...
	public String toString() {
		return "CommentVO [comment_no=" + comment_no + ", comment_writer=" + comment_writer + ", comment_post="
				+ comment_post + ", comment_text=" + comment_text + ", comment_like=" + comment_like + "]";
	}
