...
public class PostVO {
	...
	public PostVO(int post_no, String post_writer, String post_title) {
		super();
	...
	public PostVO(int post_no, String post_writer, String post_title, String post_contents, Date post_published_date,
			Date post_update_date, int post_view_count, int post_like) {
		super();
		this.post_no = post_no;
		this.post_writer = post_writer;
		this.post_title = post_title;
	...
	public String toString() {
		return "PostVO [post_no=" + post_no + ", post_writer=" + post_writer + ", post_title=" + post_title
				...
				+ ", post_update_date=" + post_update_date + ", post_view_count=" + post_view_count + ", post_like="
				+ post_like + "]";
	}
